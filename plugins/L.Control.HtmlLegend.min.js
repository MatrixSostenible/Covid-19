L.Control.HtmlLegend=L.Control.extend({
	...
	_connectLayer:function(container,legend){
		...
		L.DomUtil.create("span","slider-label",opacityController).innerHTML="";
		L.DomUtil.create("i",this.options.visibleIcon,opacityController);
var opacitySlider=L.DomUtil.create(null,opacityController);
...
L.control.htmllegend=function(options){return new L.Control.HtmlLegend(options)};